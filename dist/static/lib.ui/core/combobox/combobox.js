...
import { ComboboxWithRequest } from './combobox-with-request.js';

var Combobox = function Combobox(props) {
  if (props.onDataRequest) {
    return /*#__PURE__*/React.createElement(ComboboxWithRequest, props);
  }

  return /*#__PURE__*/React.createElement(ComboboxView, props);
};
Combobox.propTypes = {
