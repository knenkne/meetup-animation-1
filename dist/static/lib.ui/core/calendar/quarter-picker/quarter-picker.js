...
import { QuarterInput } from './quarter-input.js';

var CalendarHOCed = dropdownHandleClose(CalendarItem);
var DropdownCombinerHOCed = dropdownCombiner(QuarterInput, CalendarHOCed, style.contentsViewQuarters);
var QuarterPicker = function QuarterPicker(props) {
  return /*#__PURE__*/React.createElement(DropdownCombinerHOCed, _extends({}, props, {
