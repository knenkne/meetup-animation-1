...
import { MASK_QUARTER, EMPTY_STRING, QUARTER_PLACEHOLDER } from '../constants.js';
import 'date-fns';
...
import { quarterUnmask, quarterMask } from '../utils.js';
import '../style.css';
...
var QuarterInput = /*#__PURE__*/function (_React$Component) {
  _inherits(QuarterInput, _React$Component);

  var _super = _createSuper(QuarterInput);

  function QuarterInput() {
    var _this;

    _classCallCheck(this, QuarterInput);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (e) {
      if (Input.Masked.utils.isMaskedValue(_this.props.value)) {
        _this.props.onChange(Input.getInputDiff(e.target.value, _this.prevSelectionStart, e.target.selectionStart), e);
      } else {
        _this.props.onChange(quarterUnmask(e.target.value), e);
      }
    });

    _defineProperty(_assertThisInitialized(_this), "handleFocus", function (e) {
      _this.props.onFocus(quarterUnmask(e.target.value), e);
    });

    _defineProperty(_assertThisInitialized(_this), "handleBlur", function (e) {
      _this.props.onBlur(quarterUnmask(e.target.value), e);
    });
  ...
  _createClass(QuarterInput, [{
    ...
    value: function render() {
      ...
      var passingValue = quarterMask(value);
      return /*#__PURE__*/React.createElement("div", {
        className: theme.calendarDateTimeInputBlock
      }, /*#__PURE__*/React.createElement(Input.Masked.Typeahead.KeepCharPositions, _extends({
        inputMode: "decimal"
      }, passedProps, {
        value: passingValue,
...
export { QuarterInput };
//# sourceMappingURL=quarter-input.js.map
