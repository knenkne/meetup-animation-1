...
import { EMPTY_STRING, PLACEHOLDER, MASK_DATE, MASK_DATE_INVALID, RU_DATE_REGEXP, underScoreWidthSpaceRegExp, LOCALE } from '../constants.js';
...
var SingleInput = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(SingleInput, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          passedProps = _objectWithoutProperties(_this$props, ["value", "disabled", "theme", "icon"]);

      var inputElement = isTouchable() && isMobileEnabled() ? /*#__PURE__*/React.createElement(Input, _extends({
        inputMode: "decimal"
...
export { SingleInput };
//# sourceMappingURL=single-input.js.map
