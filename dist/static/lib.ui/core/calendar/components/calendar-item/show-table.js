...
import { Grid as Grid$1 } from '../months/grid.js';
...
import { Quarters } from '../quarters/quarters.js';
...
import '../month/row.js';
import { Grid } from '../month/grid.js';
...
var ShowTable = function ShowTable(_ref) {
  var showComponent = _ref.showComponent;

  switch (showComponent) {
    case CALENDAR_MODES.MONTHS:
      return /*#__PURE__*/React.createElement(Grid$1, null);

    case CALENDAR_MODES.QUARTERS:
      return /*#__PURE__*/React.createElement(Quarters, null);

    case CALENDAR_MODES.YEARS:
      return /*#__PURE__*/React.createElement(Years, null);
...
export { ShowTable };
//# sourceMappingURL=show-table.js.map
