...
import '../calendar-item/show-table.js';
import { CalendarItem } from '../calendar-item/calendar-item.js';
import '../../mobile-enabler.js';
import '../../calendar-input.css';
import { SingleInput } from '../../date-picker/single-input.js';

var KEY_ENTER = 13;
var dropdownCombiner = function dropdownCombiner() {
  var _class, _temp;

  var Input = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : SingleInput;
  var Calendar = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : CalendarItem;
  var contentsStyle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : style.contentsView;
  var InputHOCed = omittere(['forceOpened', 'initialTime', 'type'])(Input);
  return _temp = _class = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Wrapped, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            restriction = _this$props.restriction,
            ...
            startingYear = _this$props.startingYear,
            props = _objectWithoutProperties(_this$props, ["value", "restriction", "translations", "initialValue", "onChange", "disabled", "mode", "showDate", "startingYear"]);

        var inputPassedProps = _objectSpread2({
          disabled: disabled,
          value: value,
          onChange: onChange
        }, props);
        ...
        if (disabled) {
          return /*#__PURE__*/React.createElement(InputHOCed, inputPassedProps);
        }
        ...
        }, /*#__PURE__*/React.createElement(InputHOCed, inputPassedProps), /*#__PURE__*/React.createElement(Dropdown.Contents, {
          theme: _objectSpread2(_objectSpread2({}, Dropdown.theme), {}, {
    ...
    return Wrapped;
  }(React.Component), _defineProperty(_class, "displayName", 'dropdownCombinerHOC'), _defineProperty(_class, "propTypes", {
...
export { dropdownCombiner };
//# sourceMappingURL=dropdown-combiner.js.map
