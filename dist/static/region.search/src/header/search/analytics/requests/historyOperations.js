...
/**
 * Метрика для запроса истории операций. Собрать значение из строки поиска и время ответа сервера.
 ...
 */
export const historyOperationsMetric = (query, responseTime, responseEmpty) => {
    const metric = {
        application: APP,
 ...
 * @return {Object} - метрику
 */
export const historyOperationsAutoMetric = (query, responseTime, responseEmpty) => {
    const metric = {
        application: APP,
        action: SEARCH_SUB_REGION,
