...
const { version: libAnalyticsVersion } = require('@sbol/lib.analytics/package')
...
module.exports = {
    ...
    'res.url': `http://localhost:${process.env.PORT || '4242'}/static`,
    // HOST DDP
    ...
    'analytics.version': libAnalyticsVersion,
