...
const RangePicker = (props) => {
    ...
    const handleSubmit = useCallback(() => {
        const isRangeFromValid = rangeFrom && rangeFrom.length >= MASK_DATE.length && isValid(rangeFrom) && isDateAllowed(rangeFrom) && !isFromError
        const isRangeToValid = rangeTo && rangeTo.length >= MASK_DATE.length && isValid(rangeTo) && isDateAllowed(rangeTo) && !isToError
