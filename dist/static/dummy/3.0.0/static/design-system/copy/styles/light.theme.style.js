...
/* Background */
export const background0 = colors.graphite9
export const background1 = colors.graphite8
export const background1Narnia = 'linear-gradient(180deg, #323232 0%, #222222 46.31%)'

/* Shadows */
// shadowXSmall= colors.gray25A;
// shadowSmall= colors.gray10A;
// shadowMedium= colors.gray12A;
// shadowLarge= colors.gray15A;
// shadowXLarge= colors.gray20A;
...
export const checkboxBodyOnDisabled = successTertiary
