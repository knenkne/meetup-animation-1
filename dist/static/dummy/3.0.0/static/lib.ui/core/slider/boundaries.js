...
var getBoundaries = function getBoundaries(props) {
  if (props.options) {
    return {
...
var Boundaries = function Boundaries(props) {
  var _getBoundaries = getBoundaries(props),
      min = _getBoundaries.min,
      max = _getBoundaries.max;

  return /*#__PURE__*/React.createElement("div", {
    className: defaultTheme.boundaries
  }, /*#__PURE__*/React.createElement("div", {
    className: defaultTheme.min
  }, min), /*#__PURE__*/React.createElement("div", {
    className: defaultTheme.max
  }, max));
};
