...
var DropdownCombinerHOCed = dropdownCombiner(SingleInput, CalendarHOCed);
/**
...
var DatePicker = function DatePicker(props) {
  var initialViewDate = props.initialViewDate,
      otherProps = _objectWithoutProperties(props, ["initialViewDate"]);

  if (isTouchable() && isMobileEnabled()) {
    return /*#__PURE__*/React.createElement(SingleInput, _extends({
      type: "date"
    }, otherProps));
  }
