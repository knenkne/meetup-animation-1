...
import { CALENDAR_MODES, LOCALE } from '../../constants.js';
...
import { fullISOFormat, getQuarterNumber } from '../../utils.js';
import { useCalendarContext } from '../../context.js';
import style$1 from '../common/control.css';
import Control from '../common/control.js';
export { default as Control } from '../common/control.js';
import style from './style.css';

var Controls = function Controls() {
  var _useCalendarContext = useCalendarContext(),
      unformattedDate = _useCalendarContext.showDate,
      showComponent = _useCalendarContext.showComponent,
      setMode = _useCalendarContext.setMode,
      mode = _useCalendarContext.mode;

  var isQuartersMode = mode === CALENDAR_MODES.QUARTERS;
  var showDate = fullISOFormat(unformattedDate);
  var handleChangeViewMonth = useCallback(function () {
    return setMode(CALENDAR_MODES.MONTHS);
  }, []);
  var handleChangeViewQuarters = useCallback(function () {
    return setMode(CALENDAR_MODES.QUARTERS);
  }, []);
  var handleChangeViewYear = useCallback(function () {
    return setMode(CALENDAR_MODES.YEARS);
  }, []);
  return /*#__PURE__*/React.createElement("div", {
    className: style.header
  }, /*#__PURE__*/React.createElement("div", {
    className: style.headerMonth
  }, isQuartersMode ? /*#__PURE__*/React.createElement(Control, {
