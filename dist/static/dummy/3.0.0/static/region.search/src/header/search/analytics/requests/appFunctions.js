...
/**
 * Метрика для запроса функций приложения. Собрать значение из строкип оиска и время ответа сервера.
 ...
 */
export const appFunctionsMetric = (query, responseTime, responseEmpty) => {
    const metric = {
        application: APP,
