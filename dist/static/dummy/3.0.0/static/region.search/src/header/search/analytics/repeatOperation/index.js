...
/**
 * Метрика для повтора операции. Собрать количество элементов в блоке, позицию элемента в блоке, название, идентификатор.
 ...
 */
export const repeatOperationMetric = (count, position, name, id) => {
    const metric = {
        application: APP,
