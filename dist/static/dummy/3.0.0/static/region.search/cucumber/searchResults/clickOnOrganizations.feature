# language: ru
@important
Функционал: Ввести букву "п" и кликнуть по "ООО ЭЙВОН БЬЮТИ ПРОДАКТС КОМПАНИ"
  ...
  Сценарий: ввод, клик
    ...
    И пользователь ждет
    И пользователь ждет
    И клик по организации "ООО ЭЙВОН БЬЮТИ ПРОДАКТС КОМПАНИ", когда в строке поиска "п"
    И пользователь ждет
