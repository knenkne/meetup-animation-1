    ...
    var options3 = [
        {
            ...
            icon: 'icon:core/products/viVisa',
...
```jsx
{
                ...
                <tbody>
                    <tr>
                        <td style={{ width: "100px" }}>
                            <strong>Who What</strong>
                        </td>
                        <td
                            rowSpan="2"
                            style={{ color: "red", backgroundColor: "cyan" }}
                        >
                            А тут вообще красивая картинка на весь бэкграунд
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle">
    ...
    function WrappedDropDown(props) {
        return <Listbox as={CustomItem} {...props} />
    }
}

<Demo.Form>
    <Demo.Titled title="Очень захотелось кастомного в опциях">
        <Demo.StoreField
            name="autoselect"
            component={WrappedDropDown}
            options={options2}
            mode="autoselect"
            title="Кастомная опция"
            id="demo-custom-layout-option"
        />
    </Demo.Titled>
</Demo.Form>
```
