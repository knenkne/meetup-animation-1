...
const inputTheme = _.extend({}, defaultInputTheme, {
    ...
    disabled: classnames(defaultInputTheme.disabled, defaultTheme.disabled)
})
...
export class Counter extends React.PureComponent {
    ...
    getWarning = () => {
        const { min, max, translations: { minWarning, maxWarning }, value } = this.props
    ...
    handleDecreaseByTimes = (times) => {
        ...
        const newValue = _.toString(_.clamp(_.toInteger(value) - (times * step), min, max))
    ...
    render () {
        const { min, max, step, disabled, value, prefix, suffix, title, colorScheme, readonly, readOnly } = this.props

        const inputProps = _(this.props)
            .omit(['translations', 'step', 'colorScheme'])
            .extend({
                theme: inputTheme,
        ...
        return (
            <div className={classnames(defaultTheme.counter, defaultTheme[colorScheme])} data-unit="input:counter">
                <AdaptiveNumeric {...inputProps} />
